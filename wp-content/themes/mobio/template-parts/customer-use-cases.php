...
<div class="use-case-wrapper <?php echo $args['classExtend'] ? $args['classExtend'] : 'mr-t-250' ?> b-g-b mr-t-70-s1">
	<div class="auto-container auto">
		<div class="pa-l-30 pa-r-30">
			<p class="title-sm c-fff text-center mr-t-120 opa-5 mr-t-40-s1 f-14-s1"><?php echo $args['title'] ?></p>
			<p class="f-b f-56 f-36-s1 text-center c-fff mr-t-15 mr-t-11-s1"><?php echo $args['name'] ?></p>
		</div>
		...
		<div class="b-fff b-sd b-r-15 pa-t-50 pa-b-50 pa-l-80 pa-r-80 mr-l-100 mr-r-100 mr-t-50 mr-b-50 mr-l-45-s1 mr-r-45-s1 mr-t-30-s1 pa-0-s1" >
					...
					?>
						<div class=" mo-row-2 mo-row row pa-l-15-s1 pa-r-15-s1 pa-t-15-s1 pa-b-25-s1 slide-item" style="flex: 0 0 100%;">
							...
							<div class="mo-col-6 mo-col-12-s1 mo-col d-flex flex-column justify-content-center pa-r-80 d-none-s1">
								<p class="f-b f-64"><?php echo $args['items'][$i]['title'] ?></p>
								<p class="f-b f-30 mr-t-5"><?php echo $args['items'][$i]['title-sub'] ?></p>
								<p class="f-n f-20 mr-t-30"><?php echo $args['items'][$i]['desc'] ?></p>
