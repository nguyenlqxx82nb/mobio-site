...
<div class="header header-page">
  ...
  <div class="auto-container">
    ...
    <div class="mo-row row pa-l-40 pa-r-40 pa-l-20-s1 pa-r-20-s1 <?php echo $args['top'] ? $args['top'] : 'mr-t-95 mr-t-70 mr-t-35-s1'?>">
      
      <div class="<?php echo $args['class-col-left'] ? $args['class-col-left'] : 'mo-col-6' ?>  mo-col-12-s1 pa-0-s1">
        <?php if ($args['title']) { ?>
        <div class="f-b f-18 f-16-s4 f-12-s1 c-fff opa-5 upper-case">
          <p><?php echo $args['title'] ?></p>
        </div>
        <?php } ?>
        <div class="<?php echo $args['name-class'] ? $args['name-class'] : 'f-b f-60 mr-t-25' ?> f-40-s4  mr-t-10-s1 f-32-s1 c-fff"><p><?php echo $args['name'] ?></p></div>
        <div class="c-fff mr-t-20 f-n f-16-s4 f-14-s1 opa-8 <?php echo $args['desc-class'] ? $args['desc-class'] : 'f-24' ?> 
      ...
      <div class="<?php echo $args['class-col-right'] ? $args['class-col-right']: 'mo-col-6' ?> mo-col-12-s1 mr-t-15-s1">
        <?php 
          if ($args['video-id']) {
        ?>
