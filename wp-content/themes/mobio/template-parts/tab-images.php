...
<div class="mo-row mr-t-40 ">
  <div class="mr-l-40 mr-r-40 tab-images d-flex d-none-s1">
    <div class="d-flex flex-column tab-image-btn-container pa-r-40 d-none-s1">
  ...
  <div class="tab-wrapper d-n d-block-s1">
    <div class="b-sd auto b-r-10 mr-l-20-s1 mr-r-20-s1 pa-l-15-s1 pa-r-15-s1 mr-t-0-s1">
        
        <div class="scroll-tab mr-b-10 f-b f-22 f-16-s1 c-2 justify-content-between mr-t-25-s1 mr-b-25-s1"> 
          <?php 
        ...
        <div class="mr-t-0-s1 mr-b-20-s1">
          <?php 
              for($i=0; $i<count($args['items']); $i++) {
            ?>
