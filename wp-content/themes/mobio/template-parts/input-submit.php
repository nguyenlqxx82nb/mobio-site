...
<?php if ($args['isMobile']) { ?>
  <div class="email-submit d-n d-block-s0 <?php echo $args['classExtend'] ?>">
...
<?php if (!$args['isMobile']) { ?>
  <div class="email-submit input-wrap input-wrap-action d-none-s0 <?php echo $args['classExtend'] ?>">
    <input placeholder="Enter your email address" /> 
