<div class="mo-row tab-wrapper <?php echo $args['classExtend']; ?> mr-t-50-s1">
  <div class="auto-container">
        ...
        ?>
          <div class="flex-100 slide-item position-relative">
            <div class="mo-row mo-row-2 row">
              <div class="mo-col-6 pa-l-40 pa-r-80 mo-col-12-s1 pa-l-20-s1 pa-r-20-s1 pa-b-5-s1 pa-t-10-s1">
                <div class="upper-case f-b f-16 f-14-s1 c-4 opa-5 mr-b-15"><p><?php echo $args['items'][$i]['content']['title'] ?></p></div>
                ...
                <div class="f-n f-16 w-550 f-14-s1"><p><?php echo $args['items'][$i]['content']['desc'] ?></p></div>
              ...
              <div class="mo-col-6 mo-col-12-s1 pa-l-20-s1 pa-r-20-s1 pa-t-5-s1 pa-b-10-s1">
                <div class="w-100 pa-0 pa-0-s1 b-r-10 h-100 ">
    ...
    <div class="scroll-tab scroll-tab-top f-n f-25 f-18-s4 c-2 mr-t-60 mr-b-45 justify-content-between d-none-s1">
      <?php 
        for ($i = 0; $i < count($args['items']); $i++) {
      ?>
