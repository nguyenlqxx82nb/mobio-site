<div class="mo-row tab-wrapper <?php echo $args['classExtend']; ?> mr-t-50-s0">
  <div class="auto-container">
        ...
        ?>
          <div class="flex-100 slide-item position-relative">
            <div class="mo-row mo-row-2 row">
              <div class="mo-col-6 pa-l-40 pa-r-80 mo-col-12-s0 pa-l-20-s0 pa-r-20-s0 pa-b-5-s0 pa-t-10-s0">
                <div class="upper-case f-b f-16 f-14-s0 c-4 opa-5 mr-b-15"><p><?php echo $args['items'][$i]['content']['title'] ?></p></div>
                <div class="f-b f-48 f-30-s0 mr-b-20-s0 mr-b-30"><p><?php echo $args['items'][$i]['content']['name'] ?></p></div>
                <div class="divider-item mr-b-30  mr-b-20-s0 b-pri b-r-5"></div>
                <div class="f-n f-16 w-550 f-14-s0"><p><?php echo $args['items'][$i]['content']['desc'] ?></p></div>
              ...
              <div class="mo-col-6 mo-col-12-s0 pa-l-20-s0 pa-r-20-s0 pa-t-5-s0 pa-b-10-s0">
    ...
    <div class="scroll-tab scroll-tab-top f-n f-25 f-18-s4 c-2 mr-t-60 mr-b-45 justify-content-between d-none-s0">
      <?php 
        for ($i = 0; $i < count($args['items']); $i++) {
      ?>
