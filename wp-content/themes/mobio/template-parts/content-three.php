        ...
        <div class="mo-row mo-row-3 row">
          <?php foreach($args['items'] as $item) { ?>
            <div class="mo-col-4 mr-b-25 mo-col-12-s1">
              <div class="mo-column d-flex flex-column justify-content-between pa-t-40 pa-b-40 pa-l-40 pa-r-40 mr-l-25 mr-r-25 mr-l-0-s1 mr-r-0-s1 pa-30-s1  <?php echo $item['highlight'] ? 'b-4-b' : '' ?>">
                <div>
                  ...
                  <?php } ?>
                  <p class="f-24-s1 f-18-s4 <?php echo $args['title-class'] ? $args['title-class'] : 'f-b f-25' ?> <?php echo $item['highlight'] ? 'c-fff' : '' ?>"><?php echo $item['name'] ?></p>
