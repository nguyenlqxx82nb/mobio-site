        ...
        <div class="mo-col-4 mo-col mo-col-12-s1 mr-b-25-s1">
          <div class="mo-column justify-content-between mr-l-20 mr-r-20 mr-l-0-s1  mr-r-0-s1">
            <div>
              ...
              <div class="col-container-info pa-50-n pa-b-0 pa-30-s1 ">
                <div class="f-b f-18-s1 <?php echo $args['title-class'] ? $args['title-class'] : 'f-25' ?>"><p><?php echo $item['title'] ?></p></div>
                <div class="f-n f-20 f-14-s1 f mr-t-25 mr-t-20-s1 <?php echo $args['desc-w'] ?>">
                  <p><?php echo $item['desc'] ?></p>
                </div>
              </div>
            </div>
            <a href="<?php echo $item['next-url'] ?>" class="c-1"><p class="f-b f-20 f-16-s1 pa-l-50 pa-b-50 pa-l-30-s1 pa-b-30-s1  mr-t-30 mr-t-0-s1 mr-t-0-s1 c-1 <?php echo $args['next-class'] ? $args['next-class'] : '' ?>"><?php echo $item['next'] ?></p></a>
          </div>
        </div>
      <?php } ?>
    </div>  
