  ...
  <div class="auto-container">
    <div class=" mo-row-2 mo-row row">
      <?php if ($args['imageLeft']) { ?>
        <div class=" d-none-s0 d-flex flex-column justify-content-center <?php echo $args['classColImage'] ? $args['classColImage'] : 'mo-col-6' ?>">
      ...
      <div class="mo-col-12-s0 <?php echo $args['classColContent'] ? $args['classColContent'] : 'mo-col-6' ?> mo-col info-container d-flex flex-column justify-content-center 
        <?php echo $args['classContent'] ?  $args['classContent'] : (!$args['imageLeft'] ? 'pa-l-40 pa-r-60' : 'pa-l-100 pa-r-20') ?> pa-l-20-s0 pa-r-20-s0">
        <?php
          if ($args["icon"]) {
        ?>
        ...
        <?php } ?>
        <?php if ($args['title'] ) { ?>
          <div class="upper-case f-b f-16-s4 mr-b-10 f-13-s0 <?php echo $args['title-class'] ? $args['title-class'] : 'f-18 c-4 opa-5' ?>"><p><?php echo $args['title'] ?></p></div>
        <?php } ?>
        
        <?php if ($args['name']) { ?>
          <div class="mr-b-20 w-650  w-550-s4 f-36-s4 f-30-s0 mr-b-10-s0 <?php echo $args['nameClass'] ? $args['nameClass'] : 'f-b f-56' ?> lh2">
            <p><?php echo $args['name'] ?></p>
          </div>
        <?php }?>

        <?php echo $args['divider'] ? '<div class="divider-item mr-b-30 b-pri b-r-5"></div>' : ''  ?>
        <div class="f-n f-20 f-14-s0  f-16-s4 <?php echo $args['desc-w'] ? $args['desc-w'] : 'w-550' ?> w-450-s4 ">
          <?php echo $args['desc'] ?>
        </div>

        <?php echo $args['next'] ? '<a class="c-4-b" href="'.$args['next_url'].'"><p class="upper-case f-b f-18  f-16-s4 f-14-s0 c-4-b mr-t-25 w-300-s0">'.$args['next'].'</p></a>' : ''?>
