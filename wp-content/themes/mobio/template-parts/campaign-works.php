...
<div class="mo-row mr-t-50 mr-t-20-s1"> 
  <div class="auto-container">
    <div class="mr-l-10-s1 mr-r-10-s1 d-flex justify-content-center">
      <div class="w-1000 mo-row row">
        <?php foreach($args['items'] as $item) { ?>
          <div class="mo-col-4 pa-15 mo-col-6-s1 pa-l-10-s1 pa-r-10-s1 pa-b-0-s1">
            ...
            <div class="f-n f-w-5 f-25 f-18-s4 f-14-s1 text-center pa-t-20 pa-b-20 pa-t-15-s1 pa-b-5-s1">
