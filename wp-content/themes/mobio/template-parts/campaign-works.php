    ...
    <div class="mr-l-10-s0 mr-r-10-s0 d-flex justify-content-center">
      <div class="w-1000 mo-row row">
        <?php foreach($args['items'] as $item) { ?>
          <div class="mo-col-4 pa-15 mo-col-6-s2 pa-l-10-s2 pa-r-10-s2 pa-b-0-s2">
            ...
            <div class="f-n f-w-5 f-18 f-16-s2 f-14-s0 text-center pa-t-20 pa-b-20 pa-t-15-s2 pa-b-5-s2">
