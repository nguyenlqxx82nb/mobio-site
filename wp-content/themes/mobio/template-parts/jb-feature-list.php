...
<div class="tab-wrapper <?php echo $args['classExtend'] ?>  mr-t-30-s1">
  <div class="auto-container">
    <div class="b-sd b-fff auto mr-l-40 mr-r-40 mr-b-40 mr-t-70 pa-l-100 pa-r-80 b-r-10  mr-l-20-s1 mr-r-20-s1 pa-l-15-s1 pa-r-15-s1 mr-t-0-s1">
      ...
      <div class="scroll-tab mr-b-10 f-b f-22 f-18-s4 f-16-s1 c-2 mr-t-45 mr-b-45 justify-content-between mr-t-25-s1 mr-b-25-s1"> 
        <?php 
                ...
                <div class="mo-row row">
                  <div class="mo-col-5 mo-col-12-s1 mr-b-30-s1">
                    <div class="h-100 d-flex flex-column justify-content-center pa-r-40 pa-r-40 pa-0-s1">
                      <div class="f-b f-48 f-30-s4 f-25-s1"><p><?php echo $args['items'][$i]['title']; ?></p></div>
                      <div class="f-n f-20 f-16-s4 f-14-s1 mr-t-50  mr-t-30=s4  mr-t-20-s1"><p><?php echo $args['items'][$i]['desc']; ?></p></div>
                    </div>
                  </div>
                  <div class="mo-col-7 mo-col-12-s1">
                    <div class="h-100 <?php echo $args['items'][$i]['class-image-wrapper'] ? $args['items'][$i]['class-image-wrapper'] : 'b-g-1 b-r-10 pa-30 pa-0-s1 b-fff-s1'  ?>">
