  ...
  get_template_part('template-parts/top-tenant', null,
    array(
      ...
      'items' => array(
            ...
            get_template_directory_uri(). '/images/top-tenant/sunland.png',
      ...
      array(get_template_directory_uri(). '/images/top-tenant/bank-vietcom.png', 
            ...
            get_template_directory_uri(). '/images/top-tenant/sunhos.png',
      ...
      array(get_template_directory_uri(). '/images/top-tenant/bank-vib.png', 
            ...
            get_template_directory_uri(). '/images/top-tenant/retail-budweiser.png',
