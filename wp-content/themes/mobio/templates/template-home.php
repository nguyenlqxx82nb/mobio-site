		...
		get_template_part('template-parts/home-row-tab',null,
			array(
				...
				'items' => array(
					...
					array(
						'tab-title' => 'Trigger-based Campaign',
						'title' => '<p>Marketing Management</p>',
						...
						'img-src' => get_template_directory_uri() . '/images/home/mkt-trigger.png'
					)
				)
			));
	?>
			...
			array(
				...
				'items' => array(
					array(
						...
						'img-src' => get_template_directory_uri() . '/images/home/lead-distribution.png'
					),
					array(
					...
					array(
						...
						'img-src' => get_template_directory_uri() . '/images/home/sales-task-mngt.png'
					)
				)
			));
		?>
			...
			array(
				...
				'items' => array(
					array(
						...
						'img-src' => get_template_directory_uri() . '/images/home/service-customer-response.png'
					),
					array(
						'tab-title' => 'Ticketing',
						'title' => '<p>Service Management</p>',
