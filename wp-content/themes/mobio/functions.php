...
function twentytwenty_register_styles() {
	...
	// wp_enqueue_style( 'base-styles', get_template_directory_uri().'/styles-base.css');
	// wp_enqueue_style( 'header-styles', get_template_directory_uri().'/styles-header.css');
	// wp_enqueue_style( 'main-style', get_stylesheet_uri() );
	// wp_enqueue_style( 'media-styles', get_template_directory_uri().'/styles-media.css', false, false);
